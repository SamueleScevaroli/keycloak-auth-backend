...
import it.samusceva.backend.exceptions.NotAuthenticatedUserException;
import it.samusceva.backend.exceptions.UnknownAuthenticationException;
import it.samusceva.backend.util.assertion.Assert;
